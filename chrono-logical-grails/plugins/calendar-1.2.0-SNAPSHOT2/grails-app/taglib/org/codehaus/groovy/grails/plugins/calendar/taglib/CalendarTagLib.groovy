...
class CalendarTagLib {
    ...
    def datePicker = { attrs ->
        ...
        out << """
                    ...
                    <img src="${createLinkTo(dir:pluginContextPath,file:"images/skin/calendar.png")}" id="$name-trigger" alt="Date"/>
    ...
    def resources = { attrs ->
        ...
        if(style) {
            ...
            out << "<style type='text/css'>@import url(${createLinkTo(dir:pluginContextPath,file:theme)});</style>"
        }

        out << """
	            <script type="text/javascript" src="${createLinkTo(dir:pluginContextPath,file:"js/calendar.js")}"></script>\n
	            <script type="text/javascript" src="${createLinkTo(dir:pluginContextPath,file:"js/lang/$lang")}"></script>\n
	            <script type="text/javascript" src="${createLinkTo(dir:pluginContextPath,file:"js/calendar-setup.js")}"></script>\n
